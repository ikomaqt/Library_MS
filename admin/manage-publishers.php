...
<head>
    ...
    <title>Online Library Management System | Manage Publishers</title>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center">
                                                        <a href="edit-publisher.php?pubid=<?php echo htmlentities($result->id); ?>">
                                                            <button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button>
                                                        </a>
                                                        <a href="manage-publishers.php?del=<?php echo htmlentities($result->id); ?>" onclick="return confirm('Are you sure you want to delete?');">
